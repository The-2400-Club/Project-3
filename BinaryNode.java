class BinaryNode<T>
{
   ...
   {
      int height = 0;
      if(this != null && this.hasLeftChild() && this.hasRightChild())
         height = 1+Math.max(this.getLeftChild().getHeight_binaryNodeMethod(), this.getRightChild().getHeight_binaryNodeMethod());
      return height;
   } // end getHeight
